...
FROM registry.access.redhat.com/ubi8/nodejs-16-minimal:1-79.1669833161 as builder
USER 0
...
FROM registry.access.redhat.com/ubi8/httpd-24:1-230.1669834623 AS registry
USER 0
