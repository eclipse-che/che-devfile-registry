...
FROM registry.access.redhat.com/ubi8/nodejs-16-minimal:1-6.1638351987 as builder
USER 0
...
FROM registry.access.redhat.com/ubi8/httpd-24:1-161.1638356842 AS registry
USER 0
