...
FROM registry.access.redhat.com/ubi8/nodejs-16-minimal:1-139.1696520451 as builder
USER 0
...
FROM registry.access.redhat.com/ubi8/httpd-24:1-284.1696531168 AS registry
USER 0
