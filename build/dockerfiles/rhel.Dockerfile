...
FROM registry.access.redhat.com/ubi8/nodejs-18-minimal:1-115.1716502126 as builder
USER 0
...
FROM registry.access.redhat.com/ubi8/httpd-24:1-323.1716503935 AS registry
USER 0
