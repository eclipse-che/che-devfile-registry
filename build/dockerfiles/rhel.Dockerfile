...
FROM registry.access.redhat.com/ubi8/nodejs-16-minimal:1-98.1679485274 as builder
USER 0
...
FROM registry.access.redhat.com/ubi8/httpd-24:1-248.1679484503 AS registry
USER 0
