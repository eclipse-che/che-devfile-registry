...
FROM registry.access.redhat.com/ubi8/nodejs-16-minimal:1-14.1645811213 as builder
USER 0
...
FROM registry.access.redhat.com/ubi8/httpd-24:1-166.1645816922 AS registry
USER 0
