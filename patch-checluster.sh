...
echo "Patching CheCluster ${CHECLUSTER_NAME} in namespace ${CHECLUSTER_NAMESPACE} to use ${IMAGE} as devfile registry image."
echo
echo "Original CheCluster .spec.components.devfileRegistry:"
